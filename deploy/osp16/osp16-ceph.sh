...
IMG_URL_8="http://download-node-02.eng.bos.redhat.com/brewroot/packages/rhel-guest-image/8.1/368/images/rhel-guest-image-8.1-368.x86_64.qcow2"
...
function undercloud_install() {
  ...
  infrared tripleo-undercloud \
    ...
    --config-options DEFAULT.container_insecure_registries=registry-proxy.engineering.redhat.com/rh-osbs \
